...
const BatchSlotPage = () => {
 ...
 const data = [{"date":'29th Jan','day':"Monday"},{"date":'30th Jan','day':"Tuesday"},{"date":'31th Jan','day':"Wednesday"},{"date":'1st Feb','day':"Thursday"},{"date":'2nd Feb','day':"Friday"},{"date":'5rd Feb','day':"Monday"},{"date":'6th Feb','day':"Tuesday"},{"date":'7th Feb','day':"Wednesday"},{"date":'8th Feb','day':"Thursday"},{"date":'9th Feb','day':"Friday"},{"date":'12th Feb','day':"Monday"},{"date":'13th Feb','day':"Tuesday"},{"date":'14th Feb','day':"Wednesday"},{"date":'15th Feb','day':"Thursday"}]
  return (
    <Container>
    ...
    <div className="package">
      ...
      {data.map((date,index) => (
        ...
        <Slot id='slot' date={date.date} day={date.day}  isActive={index === selected}/>
        </div>
      ))}
    </div>
