    ...
    <Container>
      <div class="container">
        <div className="left">
          ...
          <p>
            The Yoga for Mind involves physical movement and relies on
        ...
        <div className="right">
          ...
          <div className="course-benefit">
            ...
            <br></br>
            <IoMdTime id="icon"/>
            <p id="p1">Ability to reschudule your class if you miss your session.</p>
          </div>
        </div>
